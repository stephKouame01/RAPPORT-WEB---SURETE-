...
<head>
    <meta charset="UTF-8">
    <title>🚂 Portail Sûreté SITARAIL - CI & BF</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .tabs button { min-width: 180px; padding: 12px 20px; font-size: 14px; }
...
<body>
    <header>
        <h1>🚂 Portail Centralisé Sûreté SITARAIL</h1>
        <p>CI & BF – Tous les Rapports Power BI en Un Clic</p>
    </header>

    <div class="tabs">
        <button class="active" onclick="changerRapport('cctv', this)">📹 CCTV SITARAIL</button>
        <button onclick="changerRapport('quipux', this)">📋 RELEVÉS QUIPUX</button>
        <button onclick="changerRapport('niveauAlerte', this)">⚠️ Niveau d'Alerte</button>
        <button onclick="changerRapport('sureteCIBF', this)">📊 Sûreté CI&BF</button>
    </div>

    <div class="content">
        <div id="loading" class="loading">🔄 Chargement du rapport...</div>
        <iframe 
            id="rapportIframe"
            src="https://app.powerbi.com/reportEmbed?reportId=ab84c6e7-f63f-44b0-a8da-3bbdb72aa213&ctid=088e9b00-ffd0-458e-bfa1-acf4c596d3cb"
            allowfullscreen 
    ...
    <footer>
        © 2026 – SITARAIL | Portail Sûreté Centralisé CI&BF | Powered by Power BI
    </footer>
